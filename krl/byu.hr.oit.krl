...
<a href="#{meta:host}/c/#{the_eci}/query/byu.hr.core/index.html?personExists=#{personExists(netid)}">#{full_name}<span style="float:left#{has_audio => "" | ";visibility:hidden"}">🔈</span></a>
#{is_self => <<
